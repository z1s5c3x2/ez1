...
public class BoardController {
	...
	public boolean boardUpdate(int bno,int aut,String con,String title ) {
		return BoardDao.getInstance().boardUpdate(bno,title,con,aut);

	}
	// 13. boardDelete : 게시물 삭제
	public boolean boardDelete(int bno,int aut) {
		return BoardDao.getInstance().boardDelete(bno,aut);
	}
